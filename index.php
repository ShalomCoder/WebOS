...
<body class="flex items-center justify-center min-h-screen">
  ...
  <div class="glass p-10 w-[90%] max-w-md text-center text-black">
    ...
    <h1 class="text-2xl font-bold mb-2">Welcome to WebOS</h1>
    ...
    <p class="text-left mt-3 underline text-black"><a href="./onboarding" class="text-left">Create an Account</a></p>
  </div>
